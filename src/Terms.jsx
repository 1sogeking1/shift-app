  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', fontFamily: '"Helvetica Neue", Arial, sans-serif', backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{ lineHeight: '1.8', color: '#555', fontSize: '14px' }}>
        ...
        <Section title="第6条（通知機能について）">
          <p>1. 本アプリは、シフト管理に関する重要な情報を利用者に通知する機能を提供します。</p>
          <p>2. 通知される情報には、以下が含まれます。</p>
          <ul style={{ paddingLeft: '20px', marginTop: '10px' }}>
            <li>シフトの確定・変更に関する通知</li>
            <li>勤怠に関する重要なお知らせ</li>
            <li>店舗からの業務連絡</li>
            <li>その他、本アプリの運営に必要な通知</li>
          </ul>
          <p>3. 通知はアプリ内で表示され、利用者は通知を確認・削除する権利を有します。</p>
          <p>4. 通知の受信を希望しない場合でも、シフト確定等の重要な業務連絡は送信されます。</p>
          <p>5. 通知の未確認により生じた不利益について、当社は一切の責任を負いません。</p>
        </Section>
